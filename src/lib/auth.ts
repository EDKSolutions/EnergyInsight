// NextAuth configuration is temporarily disabled as we're using Cognito for authentication
// This file is kept for reference in case we need to switch back to NextAuth
