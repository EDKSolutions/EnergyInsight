...
interface EditAssumptionsToggleProps {
  c: CalculationResult;
  showAiAssisted?: boolean;
}

const EditAssumptionsToggle: React.FC<EditAssumptionsToggleProps> = ({ c, showAiAssisted = false }) => {
  const {
    isEditMode,
    initializeEdit,
    saveChanges,
    ...
    <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
      <div className="flex items-center gap-2">
        ...
        <p className="text-lg font-bold">
          {showAiAssisted ? 'AI-Assisted Building Analysis' : 'Edit Assumptions'}
        </p>
      ...
      <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">
        {isEditMode
          ...
          : showAiAssisted
            ...
            : "Click Edit Assumptions to modify calculation parameters and assumptions."
        }
      </p>
    </div>
  )
...
export default EditAssumptionsToggle;