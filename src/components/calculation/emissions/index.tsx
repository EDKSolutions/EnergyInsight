...
import Current from './currrent/current'
import { useCalculationEdit } from '@/hooks/useCalculationEdit'
import { CalculationResult } from '@/types/calculation-result-type'
import Mixed from './mixed/mixed'
import Analysis from './ll97/analysis'

const Emissions = ({ c }: { c: CalculationResult }) => {
  const { 
    isEditMode, 
    initializeEdit, 
    saveChanges, 
    ...
    <div className="flex flex-col gap-4 mb-10">
      <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
        <div className="flex items-center gap-2">
          ...
          <p className="text-lg font-bold">Enhanced Emissions Analysis</p>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-4">
          {isEditMode 
            ...
            : "This enhanced analysis allows you to adjust mixed-use allocations, emissions factors, and DHW electrification to see real-time impact on LL97 compliance."
          }
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-white rounded-lg p-4 dark:bg-gray-800 dark:text-white">
          <Current />
        </div>
        <div className="bg-white rounded-lg p-4 dark:bg-gray-800 dark:text-white">
          <Mixed />
