...
% Upgrade completion arrow pointing to 2025
\node[anchor=south, align=center, font=\small\sffamily] at (axis cs:2025,600000) {
    \textcolor{black}{\textbf{Upgrade Complete}}\\
    \textcolor{black}{\textbf{This Year}}
};
\draw[->, color=black, line width=1.5pt] (axis cs:2025,570000) -- (axis cs:2025,520000);
...
% Upgrade completion arrow pointing to 2025
\node[anchor=south, align=center, font=\small\sffamily] at (axis cs:2025,1320) {
    \textcolor{black}{\textbf{Upgrade Complete}}\\
    \textcolor{black}{\textbf{This Year}}
};
\draw[->, color=black, line width=1.5pt] (axis cs:2025,1280) -- (axis cs:2025,1240);
...
% Upgrade completion arrow pointing to 2025
\node[anchor=south, align=center, font=\small\sffamily] at (axis cs:2025,35) {
    \textcolor{black}{\textbf{Upgrade Complete}}\\
    \textcolor{black}{\textbf{This Year}}
};
\draw[->, color=black, line width=1.5pt] (axis cs:2025,33.5) -- (axis cs:2025,31.5);
