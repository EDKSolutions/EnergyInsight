...
\begin{axis}[
    ...
    xtick={2024,2026,2028,2030,2032,2034,2036,2038,2040,2042,2044,2046,2048},
    x tick label style={rotate=90, anchor=east, /pgf/number format/fixed,/pgf/number format/1000 sep=},
    xticklabels={2024,2026,2028,2030,2032,2034,2036,2038,2040,2042,2044,2046,2048}
]
...
\draw[color=orange, line width=1.5pt, dashed] (axis cs:2026,{{NOI_Y_MIN}}) -- (axis cs:2026,{{NOI_Y_MAX}});
...
% Period labels  
\node[anchor=south, font=\scriptsize\sffamily, rotate=90] at (axis cs:2026,{{NOI_Y_MAX}}) {LL97 Fees Begin};
...
\draw[color=orange, line width=1.5pt, dashed] (axis cs:2027,{{PROPERTY_VALUE_Y_MIN}}) -- (axis cs:2027,{{PROPERTY_VALUE_Y_MAX}});
...
% Period labels
\node[anchor=south, font=\scriptsize\sffamily, rotate=90] at (axis cs:2026.5,{{PROPERTY_VALUE_Y_MAX}}) {Fees/Savings Begin};
\node[anchor=south, font=\scriptsize\sffamily, rotate=90] at (axis cs:2028.5,{{PROPERTY_VALUE_Y_MAX}}) {Reduced BE Credit};
